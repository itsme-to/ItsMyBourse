...
import fr.maxlego08.bourse.zcore.utils.nms.NMSUtils;
...
public enum Message {
	...
	NOT_ITEMS("§cVous n'avez pas cet item dans votre inventaire."),
	NOT_ENOUGH_ITEMS("§cVous n'avez pas assez d'items dans votre inventaire."),
	SELL_ITEM("§7Vous venez de vendre §ax%amount% %item%§7 pour §f%price%$§7."),
	
	INVENTORY_NOT_FOUND("§cImpossible de trouver l'inventaire !"),
	RELOAD("§aVous venez de recharger les fichiers de configurations."),
	
	NOT_ENOUGH_PLACE("§cVotre inventaire est complet."),
	NOT_ENOUGH_MONEY("§cVous n'avez pas assez d'argent."),
	
	BUY_ITEM("§7Vous venez d'acheter §ax%amount% %item%§7 pour §b%price%$§7."),
	
	SELL_ITEM_ERROR_NOTFOUND("§cImpossible de trouver l'item §f%item%§c."),
	SELL_ITEM_SUCCESS_GIVE("§aVous venez de donner §fx1 %item% §aau joueur §b%player%§a."),
	SELL_ITEM_SUCCESS_SENDER("§aVous venez de recevoir §fx1 %item%§a."),
	SELL_ITEM_ALL("§7Vous venez de vendre §ax%amount% items§7 pour §f%price%$§7."),
	SELL_ITEM_ERROR_EMPTY("§cAucun item à vendre dans se coffre."),

	ITEM_ADD("§aVous venez d'ajouter §f%amount% items§a dans pour §b%name%§a."),
