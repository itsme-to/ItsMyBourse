package fr.maxlego08.bourse.inventory;
...
import fr.maxlego08.bourse.exceptions.InventoryOpenException;
import fr.maxlego08.bourse.zcore.utils.ZUtils;
import fr.maxlego08.bourse.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.bourse.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.bourse.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected BoursePlugin plugin;
	...
	protected InventoryResult preOpenInventory(BoursePlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(BoursePlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, BoursePlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, BoursePlugin plugin, Player player) {
	}
