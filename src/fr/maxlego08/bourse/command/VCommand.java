package fr.maxlego08.bourse.command;
...
import fr.maxlego08.bourse.zcore.utils.commands.Arguments;
import fr.maxlego08.bourse.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.bourse.zcore.utils.commands.CommandType;
import fr.maxlego08.bourse.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final BoursePlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(BoursePlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(BoursePlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(BoursePlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(BoursePlugin plugin, CommandSender sender, String[] args) {
